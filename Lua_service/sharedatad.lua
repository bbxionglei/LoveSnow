...
local sharedata = require "lovesnow.sharedata.corelib"
local table = table
local cache = require "lovesnow.codecache"
...
function CMD.monitor(name, obj)
	...
	table.insert(v.watch, ls.response())
